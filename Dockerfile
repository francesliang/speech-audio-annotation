...
### Download training codes, pretrained model and its checkpoint
RUN git clone git@github.com:francesliang/deepspeech-0.6.1-fork.git ./models/deepspeech/DeepSpeech/
RUN cd ./outputs/ && \ 
